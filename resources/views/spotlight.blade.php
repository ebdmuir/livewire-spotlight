<div>
    ...
    <div x-data="LivewireUISpotlight({
        ...
        <div x-show="isOpen" @click="isOpen = false" x-transition:enter="ease-out duration-200" x-transition:enter-start="opacity-0"
            ...
            <div class="absolute inset-0 bg-white dark:bg-gray-900 opacity-50"></div>
        </div>
        ...
        <div x-show="isOpen" x-transition:enter="ease-out duration-200"
             ...
             class="relative bg-white dark:bg-gray-900 border border-gray-800 rounded-lg overflow-hidden shadow-xl transform transition-all max-w-lg w-full">
            <div class="relative">
                <div class="absolute h-full right-5 flex items-center">
                    <svg class="animate-spin h-5 w-5 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <input @keydown.tab.prevent="" @keydown.prevent.stop.enter="go()" @keydown.prevent.arrow-up="selectUp()"
                       ...
                       class="appearance-none w-full bg-transparent px-6 py-4 text-gray-700 dark:text-gray-300 text-lg placeholder-gray-500 focus:border-0 focus:border-transparent focus:shadow-none outline-none focus:outline-none"
                        ...
                        <li>
                            <button @click="go(item[0].item.id)" class="block w-full px-6 py-3 text-left"
                                ...
                                <span x-text="item[0].item.name"
                                      :class="{'text-gray-700 dark:text-gray-300': selected !== i, 'text-white': selected === i }"></span>
